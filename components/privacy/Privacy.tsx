...
const Privacy: React.FC<Props> = () => {
  return (
    <Container>
      <Contents>
        <h4>
          디엔케이드림('https://paysys.kr' 이하 행사전표시스템)은(는) [개인정보보호법]
        ...
        <ul>
          <li>
            ...
            <ul>
              <li>
                &lt;디엔케이드림&gt;(행사전표시스템)은(는) 다음의 목적을 위하여 개인정보를
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    ② 홈페이지 회원 관리와 관련한 개인정보는 수집·이용에 관한 동의일로부터
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                있으며 디엔케이드림은(는) 이에 대해 지체 없이 조치하겠습니다.
              </li>
              <li>
