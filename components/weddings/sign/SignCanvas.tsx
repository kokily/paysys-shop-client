...
import { setCurrentImg } from '../../../libs/modules/sign';
...
const SignCanvas: React.FC<Props> = ({ width, height }) => {
  ...
  useEffect(() => {
    ...
    dispatch(setCurrentImg(canvas.toDataURL('image/png')));
  ...
  }, [startPaint, paint, exitPaint, exitTouch, dispatch, startTouch, touch]);
