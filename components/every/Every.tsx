...
const Every: React.FC<Props> = () => (
  <Container>
    <Contents>
      <h4>
        디엔케이드림(이하 모두의 레시피)은(는) [개인정보보호법] 제30조에 따라 정보주체의
        개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기
        위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
      </h4>
      <h5>○ 이 개인정보처리방침은 2022년 5월 1일부터 적용됩니다.</h5>
      ...
      <ul>
        <li>
          ...
          <ul>
            <li>
              &lt;디엔케이드림&gt;(모두의 레시피)은(는) 다음의 목적을 위하여 개인정보를
        ...
        <li>
          ...
          <ul>
            <li>
              &lt;디엔케이드림&gt;은(는) 법령에 따른 개인정보 보유·이용기간 또는
            ...
            <li>
              ...
              <ul>
                <li>① 모두의 레시피 앱 회원 관리</li>
                <li>
                  ② 앱 회원 관리와 관련한 개인정보는 수집·이용에 관한 동의일로부터
        ...
        <li>
          ...
          <ul>
            <li>
              1. 정보주체는 디엔케이드림에 대해 언제든지 개인정보 열람·정정·삭제·처리정지
              요구 등의 권리를 행사할 수 있습니다.
            </li>
            <li>
              2. 제1항에 따른 권리 행사는디엔케이드림에 대해 「개인정보 보호법」 시행령
              제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며
              디엔케이드림은(는) 이에 대해 지체 없이 조치하겠습니다.
            </li>
            <li>
            ...
            <li>
              6. 디엔케이드림은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
        ...
        <li>
          ...
          <ul>
            <li>
              1. &lt;디엔케이드림&gt;은(는) 다음의 개인정보 항목을 처리하고 있습니다.
              <ul>
                <li>① 모두의 레시피 회원 관리</li>
        ...
        <li>
          ...
          <ul>
            <li>
              1. &lt;디엔케이드림&gt;은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
            ...
            <li>
              ...
              <ul>
                <li>
                  ① &lt;디엔케이드림&gt;은(는) 파기 사유가 발생한 개인정보를 선정하고,
                  &lt;디엔케이드림&gt; 의 개인정보 보호책임자의 승인을 받아 개인정보를
                  파기합니다.
                </li>
                <li>
        ...
        <li>
          ...
          <ul>
            <li>
              1. 디엔케이드림 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
              이용정보를 저장하고 수시로 불러오는 ‘스마트폰 Async Storage(이하
              스토리지)’를 사용합니다.
              <ul>
                <li>
                  ① 스토리지의 사용 목적 : 이용자가 방문한 각 서비스와 웹 사이트들에 대한
                  방문 및 이용형태, 인기 검색어, 보안접속 여부, 등을 파악하여 이용자에게
                  최적화된 정보 제공을 위해 사용됩니다.
                </li>
                <li>
                  ② 스토리지 저장을 거부할 경우 맞춤형 서비스 이용에 어려움이 발생할 수
                  있습니다.
                </li>
              </ul>
            </li>
        ...
        <li>
          ...
          <ul>
            <li>
              1. 디엔케이드림 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
            ...
            <li>
              2. 정보주체께서는 디엔케이드림 의 서비스(또는 사업)을 이용하시면서 발생한
              모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보
              보호책임자 및 담당부서로 문의하실 수 있습니다. 디엔케이드림 은(는)
        ...
        <li>
          ...
          <ul>
            <li>
              정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 상기
              책임자에게 할 수 있습니다. &lt;디엔케이드림&gt;은(는) 정보주체의 개인정보
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              2.「개인정보보호법」제35조(개인정보의 열람), 제36조(개인정보의 정정·삭제),
        ...
        <li>
          ...
          <ul>
            <li>이 개인정보처리방침은 2022년 5월 1부터 적용됩니다.</li>
          </ul>
        </li>
      </ul>
    </Contents>
